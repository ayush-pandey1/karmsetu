...
export default function Home() {
  ...
  const allProject = useSelector(
    (state) => state.freelancer.allFreelancerProjects
  );
  const completedProject = useSelector(
    (state) => state.freelancer.CompletedProjects
  );
  const ongoingProject = useSelector(
    (state) => state.freelancer.OngoingProjects
  );
  ...
  const filteredProjectsData = useSelector(
    (state) => state.freelancer.filteredProjects
  );
  useEffect(() => {
            ...
            <div className=" w-full rounded-lg ">
              ...
              <div className="grid gap-4  sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-4">
                ...
                <Card className="hidden lg:block">
                  ...
                  <CardContent className="px-3">
                    <div className="text-2xl font-bold text-primary">
                      {projectCounts.completedProjects}
                    </div>
                    <p className="text-xs pt-2 text-gray-400">
                      Updated on 10 August
                    </p>

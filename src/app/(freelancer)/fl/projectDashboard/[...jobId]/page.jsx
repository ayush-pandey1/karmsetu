            ...
            <main className="flex flex-col p-6 bg-gray-50">
                <div className="mb-6">
                    ...
                    <div className="flex items-center space-x-4 mt-4">
                        ...
                        <div>
                            <p className="text-sm text-muted-foreground">Amount Recieved</p>
                            <p className="text-lg font-bold text-blue-500">
                                ₹{project.amountRecieved}
                            </p>
                        </div>
                    </div>
                                    ...
                                    <TableRow key={milestone._id}>
                                        ...
                                        <TableCell>
                                                        ...
                                                        <div>
                                                            <Dialog>
                                                                <DialogTrigger asChild>
                                                                    <div>
                                                                        <Button className="bg-primary hover:bg-primaryho focus:bg-primary" >
                                                                            Apply Review
                                                                        </Button>
                                                                    </div>
                                                                </DialogTrigger>
                                            ...
                                            <div className="flex items-center gap-2 text-xs text-muted-foreground">
                                                ...
                                                {milestone.status === "Under Review" && (
                                                    <span>Under Review: {format(parseISO(milestone.statusDate), 'yyyy-MM-dd')}</span>
                                                )}

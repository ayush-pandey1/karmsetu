...
const Signin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const validation = signinSchema.safeParse(signinPayload);
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-8">
                ...
                >
                  ...
                  <span className="sm:block hidden">Signup with Google</span>
                </button>
                ...
                >
                  ...
                  <span className="sm:block hidden">Signup with Github</span>
                </button>
              </div>
            </div>
              ...
              <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                <div className="w-full lg:w-1/2">
                  <input
                    ...
                    className={`w-full border-b !bg-white pb-3.5 focus:border-waterloo focus:placeholder:text-black focus-visible:outline-none dark:!bg-black dark:focus:border-manatee dark:focus:placeholder:text-white disabled:opacity-60 disabled:cursor-not-allowed ${
                      fieldErrors.email
                        ? "border-red-500"

...
const Signup = () => {
  ...
  return (
    <>
      {/* <!-- ===== SignUp Form Start ===== --> */}
      <section className="pb-12.5 h-screen pt-8 lg:pb-25 lg:pt-10 xl:pb-30 xl:pt-12">
        <div className="relative z-1 mx-auto max-w-c-1016 px-7.5 pb-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
          ...
          <motion.div variants={{
            ...
            <div className="flex items-center gap-8">
              ...
              <button aria-label="signup with github" onClick={() => handleSocialLogin('github', role)} className="text-body-color dark:text-body-color-dark dark:shadow-two mb-6 flex w-full items-center justify-center rounded-sm border border-stroke bg-[#f8f8f8] px-6 py-3 text-base outline-none transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary dark:border-transparent dark:bg-[#2C303B] dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary dark:hover:shadow-none">
                <span className="mr-3">
            ...
            <form onSubmit={handleSubmit} method="post ">
              ...
              <div className="mt-12.5 border-t border-stroke py-5 text-center dark:border-strokedark">
                <p>
                  ...
                  <Link className="text-black hover:text-primary dark:text-white dark:hover:text-primary" href="/auth/signin">
                    Sign In
                  </Link>
                </p>
              </div>
